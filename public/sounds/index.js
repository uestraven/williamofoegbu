...
export const soundClips_heatwave = [
    ...
    '/sounds/heatwave/HEATWAVEEP40_BATTLE_V_3.mp3',
    '/sounds/heatwave/HEATWAVEEP40_HURT_2.mp3',
    '/sounds/heatwave/HEATWAVEEP40_OBSERVE_H_4.mp3',
];

export const soundClips_toshirou = [
    '/sounds/toshirou/TOSHIROU_College.mp3',
    '/sounds/toshirou/TOSHIROU_Daughter.mp3',
    '/sounds/toshirou/TOSHIROU_Keep_Restin.mp3',
    '/sounds/toshirou/TOSHIROU_Mom.mp3',
    '/sounds/toshirou/TOSHIROU_Proud_Father.mp3'
];

export const soundClips_kokuGanaha = [
    '/sounds/koku_ganaha/KOKU_Booster_and_Power_Limiter.mp3',
    '/sounds/koku_ganaha/KOKU_Borin.mp3',
    '/sounds/koku_ganaha/KOKU_Damn_Relic.mp3',
    '/sounds/koku_ganaha/KOKU_DOHC_32_Valve.mp3',
    '/sounds/koku_ganaha/KOKU_Step_On_the_Gas.mp3',
    '/sounds/koku_ganaha/KOKU_This_town.mp3',
    '/sounds/koku_ganaha/KOKU_Transporter_54.mp3',
    '/sounds/koku_ganaha/KOKU_We_Gotcha_Now.mp3',
